...
def ejecutar_simulacion(agua_feed, etanol_feed, temp_feed, temp_w220):
...
temp_feed = st.sidebar.slider("Temperatura de Alimentación (°C)", 10, 50, 25)
temp_w220 = st.sidebar.slider("Temperatura Calentador W-220 (°C)", 80, 110, 92)

if st.sidebar.button("Simular Proceso"):
    with st.spinner("Calculando balances y generando diagrama..."):
        try:
            df_mat, df_en, diagram_file = ejecutar_simulacion(agua_feed, etanol_feed, temp_feed, temp_w220)
